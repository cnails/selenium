...
class mytest(unittest.TestCase):
	def test_first(self):
		self.assertEqual("Congratulations! You have successfully registered!", check(link), f"problem with {link}")
	def test_simple(self):
		self.assertEqual("Congratulations! You have successfully registered!", check(link2), f"problem with {link2}")
